...
namespace BizTalk.PipelineComponents
{
    ...
    [System.Runtime.InteropServices.Guid("9FA416D7-88F6-4005-885D-8CB3AC56AF42")]
    public class WriteContext : IBaseComponent, IComponent, IComponentUI, IPersistPropertyBag
    {
       ...
       [System.ComponentModel.Editor(typeof(ContextValueCollectionEditor), typeof(System.Drawing.Design.UITypeEditor))]
        ...
        public string Description
        {
            get
            {
                return "Writes typed context properties";
            }
        }
        [System.ComponentModel.Browsable(false)]
        public string Name
        ...
        public IBaseMessage Execute(IPipelineContext pContext, IBaseMessage pInMsg)
        {
            ...
            while (e.MoveNext())
            {
                ...
                pInMsg.Context.Write(v.Key, v.Namespace, value);
        ...
        {
            classID = new Guid("9FA416D7-88F6-4005-885D-8CB3AC56AF42");
        }
